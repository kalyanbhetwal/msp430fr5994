...
#[doc = "Write Protection Detection flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Wpifg {
    #[doc = "0: No interrupt pending."]
    Wpifg0 = 0,
...
#[doc = "Field `WPIFG` reader - Write Protection Detection flag"]
...
#[doc = "Field `WPIFG` writer - Write Protection Detection flag"]
...
impl R {
    ...
    #[doc = "Bit 4 - Write Protection Detection flag"]
    #[inline(always)]
